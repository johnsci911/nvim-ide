...
require 'fzf-lua'.setup {
  ...
  files = {
    ...
    find_opts              = [[-type f -not -path '*/.git/*' -not -path '*/node_modules/*' -not -path '*/vendor/*' -not -path '*/__pycache__/*' -not -path '*/.gradle/*' -not -path '*/.terraform/*' -printf '%P\n']],
    rg_opts                = [[--color=never --files --hidden --follow -g "!.git" -g "!node_modules" -g "!vendor" -g "!__pycache__" -g "!*.pyc"]],
    fd_opts                = [[--color=never --type f --hidden --follow --exclude .git --exclude node_modules --exclude vendor --exclude __pycache__ --exclude .gradle --exclude .terraform]],
